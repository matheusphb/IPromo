...
const mockSupermarketPromotions: PromotionItem[] = [
  { id: 'sp1', name: 'Arroz Parboilizado Tipo 1 - 5kg', imageUrl: '/IPromo/imagens/promo_arroz.jpeg', discount: 'Leve 3 Pague 2' },
  { id: 'sp2', name: 'Refrigerante Guaraná 2L', imageUrl: '/IPromo/imagens/promo_refri.jpeg', discount: 'R$ 5,99' },
  { id: 'sp3', name: 'Sabão em Pó Limpeza Total 1kg', imageUrl: '/IPromo/imagens/promo_sabao.jpeg', discount: '20% OFF' },
  { id: 'sp4', name: 'Oferta de Hortifruti do Dia', imageUrl: '/IPromo/imagens/promo_horti.jpeg' },
];

const mockSupermarketCoupons: CouponItem[] = [
  { id: 'sc1', title: 'R$10 Desconto Carnes', description: 'Acima de R$50 em carnes bovinas.', imageUrl: '/IPromo/imagens/coupon_carne.jpeg' },
  { id: 'sc2', title: 'Pão Francês Grátis', description: 'Na compra de 1kg de mortadela.', imageUrl: '/IPromo/imagens/coupon_pao.jpeg' },
];
